...
const BarangForm = ({ isOpen, closeModal, onSubmit, itemToEdit }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        onSubmit({ nama, harga, id: itemToEdit ? itemToEdit.id : null });
        closeModal();
    };
        ...
        <Dialog open={isOpen} onClose={closeModal}
            ...
            <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
                <DialogPanel className="max-w-lg space-y-4 border bg-white p-12 rounded-lg">
                    <DialogTitle className="font-bold">{itemToEdit.nama != '' ? 'Edit' : 'Tambah'} Barang Sewa</DialogTitle>
                    <form onSubmit={handleSubmit} className="mt-4">
                        ...
                        <div className="mt-4">
                            ...
                            >
                                {itemToEdit.nama != '' ? 'Update' : 'Add'} Barang
                            </button>
                            <button
                                type="button"
